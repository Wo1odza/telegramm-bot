...
/skills - добавляет навык в созданные проекты
/projects - выводит все созданные проекты
/delete - удаляет созданные проекты
/update_projects - изменяет уже созданные проекты
....
